...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-6xl flex-col items-start justify-center px-4 pt-24 sm:px-6">
      <Terminal title="noc://abdosrad — route inconnue">
        <div className="space-y-1.5 font-mono text-[13px] leading-relaxed">
          ...
          <p className="text-muted">
            Le signal existe, mais pas à cette adresse. Retour au point d&apos;accès :
          </p>
      ...
      <div className="mt-8 flex gap-3">
        ...
        <Link
          href="/#projets"
          className="border border-line px-5 py-2.5 font-mono text-xs tracking-widest text-muted transition-colors hover:border-line2 hover:text-ink"
        >
          INDEX DES PROJETS
        </Link>
      </div>
